...
const addToCart = (number, name, price) => {
  ...
  ${name}
  ${price}
  <button id="cart-qty-rmv-${number}" class="cart-qty-rmv">-</button>
  <input id="cart-qty-${number}" class="cart-qty" type="number" value="1" min="1" style="width: 40px">
  <button id="cart-qty-add-${number}" class="cart-qty-add">+</button>
